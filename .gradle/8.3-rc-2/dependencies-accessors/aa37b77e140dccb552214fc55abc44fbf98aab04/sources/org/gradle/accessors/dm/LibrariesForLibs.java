...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public WindowLibraryAccessors getWindow() {
        return laccForWindowLibraryAccessors;
    }
    ...
    public static class AdaptiveLibraryAccessors extends SubDependencyFactory {
        ...
        public AdaptiveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for layout (com.google.accompanist:adaptive-layout)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLayout() {
                return create("adaptive.layout");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final AdaptiveVersionAccessors vaccForAdaptiveVersionAccessors = new AdaptiveVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: size (1.1.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: window (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.adaptive
         */
        public AdaptiveVersionAccessors getAdaptive() {
            return vaccForAdaptiveVersionAccessors;
        }
    ...
    public static class AdaptiveVersionAccessors extends VersionFactory  {

        public AdaptiveVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: adaptive.layout (0.18.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLayout() { return getVersion("adaptive.layout"); }
